...
function generateBook(buy,sell,ticker,last,prices){
    ...
    ticker.text(prices["ticker"]+" ");
    last.text(accounting.formatMoney(prices["last"],"",2,".",","));
}

$(document).ready(function() {
    var book = {"sell": [[22.7, 800], [22.95, 400], [23.0, 1000], [23.8, 300]], "buy": [[22.5, 300], [22.45, 400], [22.36, 100], [21.9, 600]], "ticker": "Brasil","last": 23.50}

    /*generate the book*/
    generateBook($("tbody[name=buy-side]"),$("tbody[name=sell-side]"),$("span[name=ticker]"),$("span[name=last]"),book)
