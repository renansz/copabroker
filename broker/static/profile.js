...
function generatePortfolio(data){
  var _html = "";
  var total = 0;
  var available = Number(getDecimalValue($("h4[name=available]").html()));
  ...
  $("h4[name=available]").html(accounting.formatMoney(available,"",2,".",","));
  $("h4[name=stocksTotal]").html(accounting.formatMoney(total,"",2,".",","));
  $("h4[name=total]").html(accounting.formatMoney(total+available,"",2,".",","));
}
